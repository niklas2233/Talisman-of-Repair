...
public final class RepairConfig {
    ...
    private static final ModConfigSpec.IntValue XP_COST;
    ...
    static {
        ...
        XP_COST = builder
                .comment("XP points charged per repair pass. 0 makes repairs free.")
                .defineInRange("xpCost", 1, 0, Integer.MAX_VALUE);
        SPEC = builder.build();
    }
    ...
    public static void setXpCost(int value) {
        XP_COST.set(value);
    }
}
